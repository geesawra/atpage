 ...
 */
export function get_raw(url) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_raw(ptr0, len0);
    return takeObject(ret);
}
...
export function resolve(event) {
    const ret = wasm.resolve(addHeapObject(event));
    return takeObject(ret);
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_log_bb6078f884123182 = function(arg0, arg1) {
    ...
    imports.wbg.__wbg_request_421c79ad5ea454cc = function(arg0) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('atresolver_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
